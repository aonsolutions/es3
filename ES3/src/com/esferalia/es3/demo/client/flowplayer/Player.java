...
import com.esferalia.es3.demo.client.flowplayer.PlayerLoadHandler;
    ...
    extends JavaScriptObject
{
    ...
    // play(configuration)
    // play([...]);
    // missing addClip(configuration, index);
    // setClip(configuration);
    ...
    public final native Player onLoad(PlayerLoadHandler handler)
    /*-{
        return this.onLoad(function() {
            var evt = new @com.esferalia.es3.demo.client.flowplayer.PlayerLoadEvent::new(Lcom/esferalia/es3/demo/client/flowplayer/Player;)(this);
            handler.@com.esferalia.es3.demo.client.flowplayer.PlayerLoadHandler::onPlayerLoad(Lcom/esferalia/es3/demo/client/flowplayer/PlayerLoadEvent;)(evt);
        });
    }-*/;
    ...
    /*-{
        var names = @com.esferalia.es3.demo.client.flowplayer.NativeHelper::fromArray([Ljava/lang/String;)(pluginNames);
